...
import com.allevite.part4_FinalProject.app.Configuration.{AppOp, IsValid, SuccessMsg, readEnv}
...
object Command :
  given showCommand: Show[Command] = Show.show(_.name)
...
object AddExpenseCommand extends Command :
  ...
  implicit val ME: MonadError[AppOp, String] = MonadError[AppOp, String]
