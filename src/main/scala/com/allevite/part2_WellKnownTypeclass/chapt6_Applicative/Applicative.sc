...
object Validated :
  ...
  given applicative: Applicative[Validated] = new Applicative[Validated] :
    ...
    override def ap[A, B](vf: Validated[A => B])(va: Validated[A]): Validated[B] =
      ...
      map2(vf,va)((f,a) => f(a)) //alternative implementation
...
//      ap(ap(ap(pure(f.curried))(va))(vb))(vc)
      val  g= Function.uncurried[A,B,C=>D](f.curried)
      ap(map2(va,vb)(g))(vc)
