package com.allevite.part2_WellKnownTypeclass.chapt7_Monad
import cats.*
...
object MonadEither :
  given eitherMonad[E]: Monad[[z] =>> Either[E, z]] = new Monad[ [x] =>> Either[E, x]] :
//  given eitherMonad[E]: Monad[Either[E, ?]] = new Monad[Either[E, ?]] :
